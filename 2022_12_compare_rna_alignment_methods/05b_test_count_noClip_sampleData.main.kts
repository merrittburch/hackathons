@file:DependsOn("com.github.samtools:htsjdk:2.24.0")
...
fun passesAlignmentFilter(currentRecord: SAMRecord, minAlignLengthProp: Double, maxNMProp: Double, minMapQ : Int = 48) : Boolean {
    ...
    return (!currentRecord.cigar.isClipped()
            && mapQ > minMapQ
            && (alignReadLength.toDouble()/actualReadLength) > minAlignLengthProp
            && (editDist.toDouble()/alignReadLength) < maxNMProp)
}
// B73
