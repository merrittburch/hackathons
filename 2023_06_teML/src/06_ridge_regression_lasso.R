...
plot_train_rr <- read.csv("../lasso_ridge_regression_results/predicted_observed_train_ridge_regression.csv", header = TRUE, sep = " ")
...
ggsave("../../images/rr_train_plot.png", rr_train_plot, 
...
#             quote = FALSE, row.names = FALSE)
plot_test_rr <- read.csv("../lasso_ridge_regression_results/predicted_observed_test_ridge_regression.csv", header = TRUE, sep = " ")
...
ggsave("../../images/rr_test_plot.png", rr_test_plot, 
       width = 8, height = 5, units = "in")
...
#             quote = FALSE, row.names = FALSE)
plot_train_lasso <- read.csv("../lasso_ridge_regression_results/predicted_observed_train_lasso.csv", header = TRUE, sep = " ")
...
ggsave("../../images/lasso_train_plot.png", lasso_train_plot, 
       width = 8, height = 5, units = "in")
...
#             quote = FALSE, row.names = FALSE)
plot_test_lasso <- read.csv("../lasso_ridge_regression_results/predicted_observed_test_lasso.csv", header = TRUE, sep = " ")
...
ggsave("../../images/lasso_test_plot.png", lasso_test_plot, 
       width = 8, height = 5, units = "in")
